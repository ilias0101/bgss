...
...         range(500000, 2000000): "плазму",
...         range(2000000, 5000000): "никель",
...         range(5000000, 20000000): "титан",
...         range(20000000, 10000000000): "кобальт",
...         range( 
...             10000000000, 10000**50
...         ): "эктоплазму",  # We don't care about the size of value, bc it's range
...     }
...     _bot = "@bforgame_bot"
... 
...     def __init__(self):
